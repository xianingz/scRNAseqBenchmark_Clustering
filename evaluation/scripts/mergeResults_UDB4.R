...
saveRDS(res, file = "~/storage/Github/scRNAseqBenchmark_Clustering/evaluation/res.UDB4.rds")
saveRDS(tru, file = "~/storage/Github/scRNAseqBenchmark_Clustering/evaluation/tru.UDB4.rds")
