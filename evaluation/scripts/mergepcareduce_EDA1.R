...
saveRDS(res, file = paste0("~/storage/Github/scRNAseqBenchmark_Clustering/evaluation/res.EDA1.rds"))
saveRDS(tru, file = paste0("~/storage/Github/scRNAseqBenchmark_Clustering/evaluation/tru.EDA1.rds"))
