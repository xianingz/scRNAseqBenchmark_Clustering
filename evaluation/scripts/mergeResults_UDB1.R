...
saveRDS(res, file = "~/storage/Github/scRNAseqBenchmark_Clustering/evaluation/res.UDB1.rds")
saveRDS(tru, file = "~/storage/Github/scRNAseqBenchmark_Clustering/evaluation/tru.UDB1.rds")
