...
saveRDS(res, file = "~/storage/Github/scRNAseqBenchmark_Clustering/evaluation/res.UDB3.rds")
saveRDS(tru, file = "~/storage/Github/scRNAseqBenchmark_Clustering/evaluation/tru.UDB3.rds")
