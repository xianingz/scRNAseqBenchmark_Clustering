...
saveRDS(res, file = paste0("~/storage/Github/scRNAseqBenchmark_Clustering/evaluation/res.EDA4.rds"))
saveRDS(tru, file = paste0("~/storage/Github/scRNAseqBenchmark_Clustering/evaluation/tru.EDA4.rds"))
