...
saveRDS(res, file = paste0("~/storage/Github/scRNAseqBenchmark_Clustering/evaluation/res.EDA3.rds"))
saveRDS(tru, file = paste0("~/storage/Github/scRNAseqBenchmark_Clustering/evaluation/tru.EDA3.rds"))
